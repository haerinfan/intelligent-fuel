...
- [Architecture](docs/architecture.md), [data contracts](contracts/data-contracts.md), [routing retention review](docs/routing-provider-retention.md), [stack decisions](docs/stack-decision.md) and [decision log](docs/decisions.md)
