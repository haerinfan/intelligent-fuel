...
| D14 | Open | Maps content persistence vs saved history | Google candidate matrix shows a material mismatch under reviewed default published terms. Select a provider/license with positive permission, obtain applicable written coverage, or explicitly revise live-history scope; Maps URL handoff remains separate | Data + lead / before M3 live storage |
