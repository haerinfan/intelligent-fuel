...
| M1.3 Data spike plan | Data | M0.2 | Select candidate variants and inspect one actual price publication; document coverage, permission and unknowns | Source inspection complete; D03/D13 acceptance open |
